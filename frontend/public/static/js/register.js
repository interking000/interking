                ...
                <div class="modal-content bg-black-glass text-white fw-bold" style="font-family: 'Segoe UI', sans-serif;">
                    ...
                    <div class="modal-body text-center">
                        ...
                        <div class="form-control bg-black-glass text-white fw-bold __data" style="overflow-y:auto; border-radius:15px;">
                            ...
                            <p class="mb-2">🎞 Cambiar Token: <a href="https://youtu.be/hz2zCdgvRzA" target="_blank" class="text-reset">Ver Tutorial</a></p>
                            <ul class="mt-4">
                                <li>Canal: <a href="https://t.me/DTunnelMod" class="text-reset">DTunnel</a></li>
                                <li>Grupo: <a href="https://t.me/DTunnelModGroup" class="text-reset">DTunnelGroup</a></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content bg-black-glass text-white fw-bold" style="font-family: 'Segoe UI', sans-serif;">
                    ...
                    <div class="modal-body text-center">
                        ...
                        <ul class="mt-3">
                            <li>Canal: <a href="https://t.me/INTER•KING" class="text-reset">DTunnel</a></li>
                            <li>Grupo: <a href="https://t.me/KING•VPNGroup" class="text-reset">DTunnelGroup</a></li>
                        </ul>
                    </div>
                </div>
            </div>

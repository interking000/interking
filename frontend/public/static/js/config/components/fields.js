...
export class ConfigSni extends TextFiled {
    ...
    validate() {
        if (!this.getValue()) {
            throw new Error('Defina ua SNI para la configuración')
        }
    }
}
...
export class ConfigOpenVPN extends TextAreaFiled {
    ...
    validate() {
        if (!this.getValue()) {
            throw new Error('Defina su certificado OpenVPN para configuración')
        }
    }
}
...
export class ConfigUdpPort extends TextFiled {
    constructor(port) {
        super()
        this._element.value = port
        this._label.innerHTML = 'Puerto de UDP'
    }
...
export class ConfigUrlCheckUser extends TextFiled {
    ...
    async _checkUrlOKClick() {
        try {
            ...
            else showToastError('URL offline o es invalida!')
        } catch (e) {
